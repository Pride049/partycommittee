package com.partycommittee.control.tree {
    ...
    */
   public class LoadingParentTree extends AutoSizeTree {
      ...
      * Constructor
      */
      public function LoadingParentTree() {
         super();
...
//         addEventListener(AdvancedMouseEvent.RIGHT_MOUSE_DOWN, onMenuSelectedHandler);
      ...
      */
      ...
      protected function callRemoteService(node:Node):void {
		 ...
		 var agencyEvent:PcAgencyEvent = new PcAgencyEvent(PcAgencyEvent.GET_CHILDREN_ONLY_PARENT);
